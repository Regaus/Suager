...
data = {
    ...
    "bang_bot": f"Why would you ever want to bang a bot? {emotes.KannaSpook}",
    ...
    "feed_bot": "Bots can't eat normal food...",
    "feed_suager": "I can't eat normal food...",
    ...
    "tag_edited": "<val1>, your tag `<val2>` has been edited.",
