...
data = {
    ...
    # "use_bot_commands": f"{emotes.Deny} Use the bot commands channel for this...",
    ...
    "birthday_self": f"I have birthday on **6th December**, thank you for asking. {emotes.AlexHeart}",
    ...
    # "birthday_set_start": "Hello there **<val1>**, please enter when you were born. `[ DD/MM ]`",
    ...
    "eat_cake": "Kakan är en lögn.",  # The cake is a lie
    "eat_noodle": "Nuudeli on liian maukas tullakseen syödyksi.",  # Noodle is too tasty to be eaten
    "eat_regaus": "Hai te a muraan, ar kyda? Te vai deiken annar eitean.",  # Do you wanna die or something? You're never gonna eat him.
    "eat_suager": "Taa e ne, ne te a jan deamar? Paira eidea ta ten?",  # So that's what you think of me? Just some food for you?
    ...
    "bad_locked": "Sometimes you need to look at yourself too, <val1>...",
