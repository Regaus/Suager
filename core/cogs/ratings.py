    ...
    async def friend_calc(self, ctx: commands.Context, user1: discord.User, user2: discord.User):
        ...
        if user1.id == 302851022790066185 or user2.id == 302851022790066185:
            ...
            friendships = {
                ...
                374853432168808448: 0.9100,  # Potato
                430891116318031872: 0.8672,  # Alex Five
                499038637631995906: 0.8631,  # Ash
                533680271057354762: 0.8584,  # Spoopy
                ...
                739806142560993380: 0.6725,  # Fekuri
                236884090651934721: 0.6678,  # Shawn
                443363116504580117: 0.2173,  # Dragon
                377467233401831424: 0.1102,  # mags
                781907210182590514: 0.1047,  # jelly
                561164743562493952: 0.0173,  # zilla
                746173049174229142: 0.0000,  # racc
                690328607205491101: -.0064,  # yerin
