    ...
    async def friend_calc(self, ctx: commands.Context, user1: discord.User, user2: discord.User):
        ...
        if user1.id == 302851022790066185 or user2.id == 302851022790066185:
            ...
            friendships = {
                ...
                # 593736085327314954: 0.9047,  # Chuck
                593736085327314954: 0.0000,  # Chuck
                374853432168808448: 0.9043,  # Potato
                533680271057354762: 0.8472,  # Spoopy
                430891116318031872: 0.8367,  # Alex Five
                ...
                377467233401831424: 0.0447,  # mags
                561164743562493952: 0.0102,  # zilla
