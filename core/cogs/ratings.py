    ...
    async def friend_calc(self, ctx: commands.Context, user1: discord.User, user2: discord.User):
        ...
        if user1.id == 302851022790066185 or user2.id == 302851022790066185:
            ...
            friendships = {
                ...
                593736085327314954: 0.9045,  # Chuck
                374853432168808448: 0.9045,  # Potato
                533680271057354762: 0.8472,  # Spoopy
                430891116318031872: 0.8417,  # Alex Five
                597373963571691520: 0.8351,  # Nuriki
                499038637631995906: 0.8291,  # Ash
                ...
                377467233401831424: 0.1102,  # mags
                781907210182590514: 0.1047,  # Jellybonk
                561164743562493952: 0.0317,  # zilla
                690328607205491101: 0.0064,  # yerin
