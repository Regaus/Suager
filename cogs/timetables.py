...
STOP_HUBS: dict[str, list[str]] = {
    ...
    "Bray Station":       ["8350IR0123",   "8350DB004156", "8350DB002974", "8350DB002973", "8350DB004168", "8350DB004169"],
    ...
    "Regaus Southbound":  ["8220DB007571", "8220DB000037", "8220DB001646", "8220DB000213", "8220DB008246", "8220IR0027",   "8220IR3881",   "8220IR0025",   "8220DB000334"],
...
class Timetables(University, Luas, name="Timetables"):
    def __init__(self, bot: bot_data.Bot):
        ...
        self.WRITE = self.bot.full_name == "Linenvürteat"  # Write real-time data to disk (enabled for dev, disabled in prod)
