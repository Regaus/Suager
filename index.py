...
bot = botdata.Bot(command_prefix=get_prefix, prefix=config["prefixes"], command_attrs=dict(hidden=True), case_insensitive=True,
                  help_command=botdata.HelpFormat(), owner_ids=generic.owners, activity=discord.Game(name=config["playing"]), status=discord.Status.dnd)
