...
- Fixed pardons being treated as warnings in the mod logs
...
- Made the `//sync` command more intuitive
...
## v8.0.0a15 - 22-24 January 2025
- Made the `//stars` command hybrid
  - Changed the primary name to `//starboard`
...
- Split `//remind` into `//remind in` and `//remind on`, thereby making it possible to specify a date and time when to send the reminder
