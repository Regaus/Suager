...
class Leveling(commands.Cog):
    ...
    async def on_message(self, ctx: discord.Message):
        ...
        try:
            ...
            sm = 1
        c = 0.75 if ctx.author.id in [667187968145883146] else 1
        c = 0.87 if ctx.author.id in [742929135713910815, 579369168797958163, 740262813049684069, 402250088673574913, 746173049174229142] else c
        c = 0.93 if ctx.author.id in [499038637631995906] else c
